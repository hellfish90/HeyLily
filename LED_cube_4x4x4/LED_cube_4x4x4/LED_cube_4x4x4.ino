...
#define TIMECONST 7 // multiplies DisplayTime to get ms - why not =100?

// LED Pattern Table in PROGMEM - last column is display time in 100ms units
// TODO this could be a lot more compact but not with binary pattern representation
const unsigned char PROGMEM okCube[] = {
...
const unsigned char PROGMEM listenCube[] = {
...
const unsigned char PROGMEM blackCube[] = {
...
if(command==0){
 ...
 memcpy_P( PatternBuf, okCube + PatternIdx, PLANESIZE );
PatternIdx += PLANESIZE;
// read DisplayTime from PROGMEM and increment index
DisplayTime = pgm_read_byte_near( okCube + PatternIdx++ );
 ...
 memcpy_P( PatternBuf, listenCube + PatternIdx, PLANESIZE );
PatternIdx += PLANESIZE;
// read DisplayTime from PROGMEM and increment index
DisplayTime = pgm_read_byte_near( listenCube + PatternIdx++ );
 ...
 memcpy_P( PatternBuf, blackCube + PatternIdx, PLANESIZE );
PatternIdx += PLANESIZE;
// read DisplayTime from PROGMEM and increment index
DisplayTime = pgm_read_byte_near( blackCube + PatternIdx++ );
